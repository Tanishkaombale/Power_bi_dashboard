...
![Data Jobs Dashboard 2.0](/images/Project1_page1_new.png)
...
Each dashboard linked above has its own detailed `README.md` file within this respective project folder. These offer deeper insights into the projetc objectives , data sources, specific Power BI techniques employed, and a closer look at the dashboard build.
